...
public class WifiConfigManagerTest extends WifiBaseTest {
    ...
    public void testHandleUserSwitchDoesNotChangeSharedNetworksId() throws Exception {
        ...
        List<WifiConfiguration> sharedNetworks = List.of(
            sharedNetwork1,
            sharedNetwork2);
