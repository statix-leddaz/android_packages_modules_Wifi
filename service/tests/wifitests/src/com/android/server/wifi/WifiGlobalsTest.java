...
public class WifiGlobalsTest extends WifiBaseTest {
    ...
    public void testForceOverlayConfigValue() throws Exception {
        ...
        assertFalse(mWifiGlobals.forceOverlayConfigValue("abc", "disabled", TEST_ISENABLED));
        ...
        assertFalse(mWifiGlobals.forceOverlayConfigValue(TEST_CONFIG, TEST_VALUE, false));

        // mWifiGlobals = new WifiGlobals(mContext);
        assertTrue(mWifiGlobals.forceOverlayConfigValue(TEST_CONFIG, "abc", TEST_ISENABLED));
        assertTrue(mWifiGlobals.forceOverlayConfigValue(TEST_CONFIG, "disabled", TEST_ISENABLED));
