...
public class SupplicantP2pIfaceHalHidlImplTest extends WifiBaseTest {
    ...
    private static final ArrayList<Byte> createSsidBytes() {
    ...
    private static final ArrayList<Byte> createValidBonjourServiceRequest() {
        ArrayList<Byte> result = new ArrayList<Byte>();
        result.add((byte) '0');
        result.add((byte) '1');
        result.add((byte) '2');
    ...
    private static final ArrayList<Byte> createValidBonjourServiceResponse() {
        ArrayList<Byte> result = new ArrayList<Byte>();
        result.add((byte) '4');
        result.add((byte) '5');
        result.add((byte) '6');
