...
public class WifiP2pShellCommand extends BasicShellCommandHandler {
    ...
    private WifiP2pConfig buildWifiP2pConfig(PrintWriter pw) {
        ...
        WifiP2pConfig config = new WifiP2pConfig.Builder()
                .setGroupClientIpProvisioningMode(ipProvisioningMode)
    ...
    public void onHelp() {
        ...
        pw.println("    -i <groupOwnerIntent> - Set group owner intent from "
                + WifiP2pConfig.GROUP_OWNER_INTENT_MIN + " to "
                + WifiP2pConfig.GROUP_OWNER_INTENT_MAX);
        pw.println("    -m <groupClientIpProvisioningMode> - Set group client IP provisioning "
                        + "mode.");
