...
public class WifiConfigurationUtil {
    ...
    private static void ignoreIsAddedByAutoUpgrade(List<SecurityParams> exist, WifiConfiguration temp) {
        for (SecurityParams param : exist) {
            temp.setSecurityParamsIsAddedByAutoUpgrade(param.getSecurityType(), param.isAddedByAutoUpgrade());
        }
    }
