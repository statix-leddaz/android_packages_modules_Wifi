...
public class MockSupplicantManager {
    ...
    private HashMap<String, ISupplicantStaIface> mMockISupplicantStaIfaces = new HashMap<>();

    public MockSupplicantManager(IBinder supplicantBinder, Context context,
        ...
        for (String ifaceName : mWifiMonitor.getMonitoredIfaceNames()) {
            ...
            try {
                ...
                Log.d(TAG, "Failed to create ISupplicantStaIface due to exception");
            }
        }
    }
