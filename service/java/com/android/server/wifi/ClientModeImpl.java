...
public class ClientModeImpl extends StateMachine implements ClientMode {
    ...
    private State mWaitBeforeL3ProvisioningState = new WaitBeforeL3ProvisioningState();
    ...
    class WaitBeforeL3ProvisioningState extends State {
        @Override
        public void enter() {
            ...
            // Await IpClient recreation timeout, send message to proceed to Disconnected state.
        ...
        public boolean processMessage(Message message) {
            switch(message.what) {
                ...
                case CMD_IPCLIENT_STARTUP_TIMEOUT: {
                    Log.e(getTag(), "Fail to create an IpClient instance within 2s");
                    handleNetworkDisconnect(false,
