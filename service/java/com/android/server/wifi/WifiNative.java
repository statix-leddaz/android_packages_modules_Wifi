...
public class WifiNative {
    ...
    public ArrayList<ScanDetail> getPnoScanResults(@NonNull String ifaceName) {
        if (mMockWifiModem != null && mMockWifiModem.getIsMethodConfigured(MockWifiServiceUtil.MIN_SERVICE_IDX, "getPnoScanResults")) {
    ...
    public boolean startPnoScan(@NonNull String ifaceName, PnoSettings pnoSettings) {
        if (mMockWifiModem != null && mMockWifiModem.getIsMethodConfigured(MockWifiServiceUtil.MIN_SERVICE_IDX, "startPnoScan")) {
    ...
    public WifiSignalPollResults signalPoll(@NonNull String ifaceName) {
        if (mMockWifiModem != null && mMockWifiModem.getIsMethodConfigured(MockWifiServiceUtil.MIN_SERVICE_IDX, "signalPoll")) {
