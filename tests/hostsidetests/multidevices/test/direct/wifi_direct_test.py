...
_WIFI_DIRECT_SNIPPET_KEY = 'wifi_direct_snippet'
_ACTION_LISTENER_ON_SUCCESS = 'onSuccess'
_ACTION_LISTENER_ON_FAILURE = 'onFailure'
_ACTION_LISTENER_FAILURE_REASON = 'reason'
